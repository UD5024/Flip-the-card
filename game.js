    ...
    if (tried != 0) {
        ...
        if (opened == 8) {
            ...
            setTimeout(function() {
                ...
                else {var describe = "雖然過了，但是錯過太多機會囉";}
        ...
        if (graphic == 0) {
            tried = 0;
            setTimeout(function() {
                if ((opened == 6)&&(count-opened <= 2)) {var describe = "太可惜了就差一張";}
                else if (opened == 6) {var describe = "真可惜，只差一組牌";}
                else if (opened >= 2) {var describe = "再接再厲，下次不一定會更好";}
                else {var describe = "哀呀，太慘了";}
